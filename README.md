...
- `paper/Wick_Raw_Product_Landscape_Preprint_v0.3.1.pdf` — revised English preprint generated by the release workflow.
- `paper/main.tex` — reconstructed complete LaTeX source.
...
- `reviews/v0.2/` and `reviews/v0.3/` — source audit records.
- `src/`, `scripts/`, and `tests/` — reproducibility code.
...
The GitHub Actions workflow reconstructs the complete source, reruns the mathematical audit, regenerates figures, recompiles both PDFs, and commits the generated artifacts.
